...
cresult.to_csv(r'/home/vm21/PanClassify/data/std_Cancer.txt.bz2',compression="bz2", sep='\t',header=None,index=None,index_label=None)

nresult.to_csv(r'/home/vm21/PanClassify/data/std_Normal.txt.bz2',compression="bz2", sep='\t',header=None,index=None,index_label=None)
